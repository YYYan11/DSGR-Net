...
def compute_irrigation_gradient(
    model,
    sequence,
    static,
    irrigation_channel_index
):
    """
    Compute:
        dYield / dIrrigation

    Irrigation only affects yield through
    differentiable crop-water process.
    """
    ...
    irrigation_gradient = gradient[
        :,
        :,
        irrigation_channel_index
    ]

    return irrigation_gradient.detach()
